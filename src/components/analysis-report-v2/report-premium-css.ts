// V2 결과 보고서 디자인 CSS (2차 다듬기: 톤 다운·쉬운말·모바일 우선).
// 화이트 본문 기반, 네이비·골드는 포인트로만. 다크 블록은 표지 헤더 + 핵심 판정 패널 2곳으로 축소.
// 세리프 폰트 제거(앱 산세리프로 통일). 영문 eyebrow 제거. 카카오 인앱(모바일) 가독성 우선.
// 모든 규칙은 .rptv2-doc 스코프 하위에서만 적용. 데이터·문구·점수 로직은 컴포넌트/서버에서 결정.
...
.premium-brand__mark {
  ...
  background: var(--navy); border-radius: 8px; color: #fff; font-size: 14px; font-weight: 800;
}
.premium-brand > span:last-child { display: grid; gap: 1px; }
.premium-brand strong { color: var(--navy); font-size: 14px; font-weight: 800; }
.premium-brand small { color: var(--muted); font-size: 12px; font-weight: 700; }
...
.audience-switch button {
  min-height: 36px; padding: 7px 13px; background: transparent; border: 0; border-radius: 6px;
...
.report-command {
  min-height: 38px; padding: 7px 14px; display: inline-flex; align-items: center; gap: 7px;
...
.report-share {
  min-height: 38px; padding: 7px 12px; display: inline-flex; align-items: center; gap: 6px;
...
/* ── 표지(유일한 다크 헤더) ────────────────────────────────── */
.report-v2-cover {
  position: relative; padding: 34px 40px 28px; overflow: hidden;
...
.cover-brand-line, .cover-footer {
  ...
  color: #aeb8c8; font-size: 12.5px; font-weight: 700;
}
...
.cover-copy > p { margin: 0 0 10px; color: var(--brass-soft); font-size: 13px; font-weight: 700; }
.cover-copy h1 { margin: 0; color: #fff; font-size: 34px; font-weight: 800; line-height: 1.28; letter-spacing: -0.01em; word-break: keep-all; }
.cover-copy h1 em { color: #e8cf9d; font-style: normal; }
.cover-meta { margin-top: 22px; display: flex; flex-wrap: wrap; gap: 6px 16px; color: #c4cede; font-size: 13px; font-weight: 600; }
.cover-meta span + span::before { margin-right: 16px; color: #55617a; content: "·"; }
.cover-verdict { padding: 22px; background: #fff; border-radius: 10px; color: var(--ink-950); }
.cover-verdict > span { color: var(--brass-dark); font-size: 12.5px; font-weight: 800; }
.cover-verdict strong, .cover-verdict b { display: block; }
.cover-verdict strong { margin-top: 8px; font-size: 22px; font-weight: 800; line-height: 1.3; }
.cover-verdict b { margin-top: 4px; color: var(--brass-dark); font-size: 13.5px; font-weight: 700; }
.cover-verdict p { margin: 12px 0 0; color: var(--text); font-size: 13.5px; line-height: 1.7; }
.cover-footer { padding-top: 14px; border-top: 1px solid rgba(255,255,255,0.14); }

/* ── 섹션 + 번호 헤딩(화이트) ──────────────────────────────── */
.report-v2-section { padding: 40px 40px; border-bottom: 1px solid var(--line); scroll-margin-top: 80px; }
.luxury-section-heading { margin-bottom: 22px; }
...
.luxury-section-heading h2 { margin: 0; color: var(--ink-950); font-size: 22px; font-weight: 800; letter-spacing: -0.01em; }
.luxury-section-heading__caption { margin: 12px 0 0; color: var(--muted); font-size: 13.5px; line-height: 1.6; }
.confidence-chip, .section-note, .fit-grade {
  padding: 6px 11px; border-radius: 999px; font-size: 12.5px; font-weight: 800; white-space: nowrap;
}
...
/* ── 핵심 지도 판정(유일한 다크 본문 패널) ─────────────────── */
.analysis-verdict { overflow: hidden; background: var(--navy); border-radius: 12px; color: #fff; }
.analysis-verdict__title { padding: 20px 24px 0; display: flex; align-items: center; justify-content: space-between; gap: 14px; flex-wrap: wrap; }
.analysis-verdict__title > span { color: var(--brass-soft); font-size: 12.5px; font-weight: 800; }
.analysis-verdict__title > b {
  padding: 6px 10px; background: rgba(255,255,255,0.12); border-radius: 999px; color: #e8cf9d; font-size: 12.5px; font-weight: 700;
}
.analysis-verdict > h3 {
  max-width: 900px; margin: 14px 24px 0; font-size: 23px; font-weight: 800; line-height: 1.5; word-break: keep-all;
}
.analysis-verdict > h3 em { color: #e8cf9d; font-style: normal; }
.analysis-verdict__body { margin-top: 20px; display: grid; grid-template-columns: repeat(3, minmax(0,1fr)); border-top: 1px solid rgba(255,255,255,0.12); }
.analysis-verdict__body p { margin: 0; padding: 18px 20px; color: #d7deea; font-size: 14px; line-height: 1.78; border-right: 1px solid rgba(255,255,255,0.12); word-break: keep-all; }
...
.analysis-chain > div { padding: 16px 18px; border-right: 1px solid rgba(255,255,255,0.12); }
.analysis-chain > div:last-child { border-right: 0; }
.analysis-chain dt { color: var(--brass-soft); font-size: 12.5px; font-weight: 800; }
.analysis-chain dd { margin: 6px 0 0; color: #fff; font-size: 13px; font-weight: 600; line-height: 1.55; }
...
.analysis-figure figcaption span { color: var(--brass-dark); font-size: 12.5px; font-weight: 800; }
.analysis-figure figcaption strong { color: var(--ink-950); font-size: 16px; font-weight: 700; }
.analysis-figure svg { width: 100%; height: auto; display: block; overflow: visible; margin-top: 8px; }
.analysis-figure > p { margin: 10px 0 0; padding: 12px 14px; background: var(--ivory); border-radius: 8px; color: var(--muted); font-size: 13px; line-height: 1.65; }
.analysis-figure > p strong { color: var(--ink-950); }

/* ── 교차 근거 ─────────────────────────────────────────────── */
.analysis-cross-evidence { padding: 20px; background: var(--ivory); border-radius: 12px; }
.analysis-cross-evidence > header h3 { margin: 0; font-size: 16px; font-weight: 700; color: var(--ink-950); }
...
.analysis-cross-evidence article span { color: var(--blue); font-size: 12.5px; font-weight: 800; }
.analysis-cross-evidence article p { margin: 6px 0 0; color: var(--text); font-size: 13.5px; line-height: 1.6; }
...
.executive-statement > span { color: var(--brass-dark); font-size: 12.5px; font-weight: 800; }
.executive-statement h3 { margin: 10px 0 0; color: var(--ink-950); font-size: 19px; font-weight: 800; line-height: 1.5; word-break: keep-all; }
.executive-statement > p { margin: 12px 0 0; color: var(--text); font-size: 14px; line-height: 1.75; }
.executive-statement ul { margin: 14px 0 0; padding: 12px 0 0 18px; display: grid; gap: 6px; border-top: 1px solid var(--line-strong); color: var(--ink-800); font-size: 13.5px; font-weight: 600; }
...
.fit-seal-panel > span { color: var(--brass-dark); font-size: 12.5px; font-weight: 800; }
.fit-seal { width: 104px; height: 104px; margin-top: 14px; display: grid; grid-template-columns: auto auto; place-content: center; align-items: end; border: 2px solid var(--brass); border-radius: 50%; }
.fit-seal strong { color: var(--navy); font-size: 34px; font-weight: 800; line-height: 1; }
.fit-seal small { padding-bottom: 4px; color: var(--muted); font-size: 12.5px; }
.fit-seal-panel h3 { margin: 14px 0 0; color: var(--navy); font-size: 15px; font-weight: 800; }
.fit-seal-panel p { margin: 8px 0 0; color: var(--text); font-size: 13px; line-height: 1.6; }

/* ── 핵심 신호 카드 ────────────────────────────────────────── */
.profile-signals { display: grid; grid-template-columns: repeat(3, minmax(0,1fr)); gap: 10px; }
.profile-signals article { padding: 16px; display: grid; grid-template-columns: minmax(0,1fr) auto; grid-template-rows: auto auto 1fr; gap: 3px 10px; background: #fff; border: 1px solid var(--line); border-top: 4px solid var(--teal); border-radius: 10px; }
.profile-signals article.is-caution { border-top-color: var(--coral); }
.profile-signals article > span { color: var(--muted); font-size: 12.5px; font-weight: 800; }
.profile-signals article > strong { color: var(--ink-950); font-size: 13.5px; font-weight: 800; }
.profile-signals article > b { grid-row: 1 / 3; grid-column: 2; color: var(--navy); font-size: 24px; font-weight: 800; }
.profile-signals article > p { grid-column: 1 / -1; margin: 6px 0 0; color: var(--muted); font-size: 12.5px; line-height: 1.5; }
...
.teacher-brief__title span { color: var(--brass-dark); font-size: 12.5px; font-weight: 800; }
.teacher-brief__title h3 { margin: 6px 0 0; color: var(--ink-950); font-size: 16px; font-weight: 700; line-height: 1.5; }
...
.teacher-brief li > span { flex: 0 0 auto; color: var(--brass-dark); font-size: 13px; font-weight: 800; }
.teacher-brief li p { margin: 0; color: var(--text); font-size: 13.5px; line-height: 1.6; }
...
.consultation-context-dossier > header h3 { margin: 0; color: var(--ink-950); font-size: 16px; font-weight: 700; }
.consultation-context-dossier > header > b { padding: 6px 10px; background: var(--blue-soft); border-radius: 999px; color: var(--blue); font-size: 12px; font-weight: 700; }
...
.context-meta-grid span { color: var(--muted); font-size: 12.5px; font-weight: 700; }
.context-meta-grid strong { color: var(--ink-950); font-size: 13.5px; font-weight: 700; line-height: 1.45; word-break: keep-all; }
...
.context-consult-questions > div span { color: var(--brass-dark); font-size: 12.5px; font-weight: 800; }
.context-consult-questions > div strong { display: block; margin-top: 4px; color: var(--ink-950); font-size: 15px; font-weight: 700; line-height: 1.5; }
...
.context-consult-questions li b { color: var(--brass-dark); font-size: 12.5px; font-weight: 800; }
.context-consult-questions li p { margin: 0; color: var(--text); font-size: 13px; line-height: 1.55; }
...
.panel-title > span { width: 100%; color: var(--brass-dark); font-size: 12.5px; font-weight: 800; }
.panel-title h3 { margin: 0; color: var(--ink-950); font-size: 16.5px; font-weight: 700; }
.panel-title > b { color: var(--navy); font-size: 20px; font-weight: 800; }
...
.bullet-bars span, .coaching-lines span, .phone-bars span { color: var(--text); font-size: 13px; font-weight: 700; }
...
.coaching-dossier blockquote strong { color: var(--navy); font-size: 14.5px; font-weight: 800; }
.coaching-dossier blockquote p { margin: 6px 0 0; color: var(--text); font-size: 13.5px; line-height: 1.65; }
.will-dossier > p { margin: 18px 0 0; padding-top: 14px; border-top: 1px solid var(--line); color: var(--text); font-size: 13.5px; line-height: 1.7; }
...
.phone-score-block > span { color: var(--brass-dark); font-size: 12.5px; font-weight: 800; }
.phone-score-block > strong { margin-top: 8px; color: var(--navy); font-size: 44px; font-weight: 800; line-height: 1; }
.phone-score-block > b { margin-top: 8px; color: var(--ink-950); font-size: 14px; font-weight: 700; }
.phone-score-block > p { margin: 8px 0 0; color: var(--muted); font-size: 12.5px; line-height: 1.55; }
.phone-analysis { padding: 22px; }
.phone-bars { margin-top: 0; }

/* ── 성격(MBTI)/친구(밝은) ─────────────────────────────────── */
.personality-panel > p { margin: 14px 0 0; color: var(--text); font-size: 13.5px; line-height: 1.75; }
...
.mbti-adjustment-panel > div span { color: var(--blue); font-size: 12.5px; font-weight: 800; }
.mbti-adjustment-panel > div strong { color: var(--ink-950); font-size: 13px; font-weight: 700; }
...
.mbti-adjustment-panel dt { color: var(--text); font-size: 13px; font-weight: 700; }
.mbti-adjustment-panel dd { margin: 7px 0 0; display: grid; grid-template-columns: 1fr auto auto; gap: 7px; align-items: baseline; }
.mbti-adjustment-panel dd span { color: var(--muted); font-size: 12.5px; }
.mbti-adjustment-panel dd b { color: var(--brass-dark); font-size: 12.5px; font-weight: 700; }
.mbti-adjustment-panel dd strong { color: var(--blue); font-size: 15px; font-weight: 800; }
.mbti-adjustment-panel > p { margin: 0; padding: 11px 14px; color: var(--muted); font-size: 12.5px; line-height: 1.55; }
.personality-panel > small { display: block; margin-top: 14px; padding-top: 12px; border-top: 1px solid var(--line); color: var(--muted); font-size: 12.5px; line-height: 1.55; }
...
.spectrum-list span { color: var(--muted); font-size: 12.5px; font-weight: 700; }
...
.relation-signals span { color: var(--muted); font-size: 12.5px; font-weight: 800; }
.relation-signals strong { margin-top: 4px; display: block; color: var(--navy); font-size: 20px; font-weight: 800; }
.relation-signals p { margin: 5px 0 0; color: var(--text); font-size: 12.5px; line-height: 1.5; }
.relation-note { margin: 14px 0 0; padding-top: 13px; border-top: 1px solid var(--line); color: var(--text); font-size: 13px; line-height: 1.65; }
...
.fit-intro h3 { margin: 0; color: var(--ink-950); font-size: 17px; font-weight: 800; line-height: 1.55; word-break: keep-all; }
.fit-intro h3 em { color: var(--brass-dark); font-style: normal; }
.fit-intro p { margin: 0; color: var(--text); font-size: 13.5px; line-height: 1.75; }
...
.fit-feature-list article > div:first-child span { display: block; color: var(--muted); font-size: 12.5px; font-weight: 800; }
.fit-feature-list article > div:first-child strong { display: block; margin-top: 6px; color: var(--ink-950); font-size: 14px; font-weight: 800; }
.fit-feature-list article > p { margin: 0; color: var(--muted); font-size: 13px; line-height: 1.6; }
.dual-fit { display: grid; gap: 9px; }
.dual-fit p { margin: 0; display: grid; grid-template-columns: 60px 32px minmax(0,1fr); gap: 7px; align-items: center; color: var(--muted); font-size: 12.5px; font-weight: 700; }
...
.fit-consult-note > div span { display: block; color: var(--brass-dark); font-size: 12.5px; font-weight: 800; }
.fit-consult-note > div strong { display: block; margin-top: 5px; color: var(--ink-950); font-size: 13px; font-weight: 700; }
.fit-consult-note > p { grid-column: 1 / -1; margin: 0; padding-top: 12px; border-top: 1px solid rgba(138,100,34,0.2); color: #6b542a; font-size: 12.5px; line-height: 1.6; }

/* ── 과목 전략(밝은) ───────────────────────────────────────── */
.subject-dossier { margin-top: 18px; padding-top: 18px; border-top: 1px solid var(--line); }
.subject-dossier__head { margin-bottom: 14px; }
.subject-dossier__head span { color: var(--brass-dark); font-size: 12.5px; font-weight: 800; }
.subject-dossier__head h3 { margin: 4px 0 0; color: var(--ink-950); font-size: 17px; font-weight: 800; }
...
.subject-v2-summary > span { color: var(--brass-dark); font-size: 12.5px; font-weight: 800; }
.subject-v2-summary h4 { margin: 5px 0 14px; color: var(--ink-950); font-size: 16px; font-weight: 800; }
.subject-v2-summary > div { display: flex; align-items: end; gap: 4px; }
.subject-v2-summary > div strong { color: var(--navy); font-size: 40px; font-weight: 800; line-height: 1; }
.subject-v2-summary > div small { padding-bottom: 5px; color: var(--muted); font-size: 12.5px; }
.subject-v2-summary > p { margin: 9px 0 0; color: var(--text); font-size: 13px; line-height: 1.7; }
...
.subject-v2-metrics span { color: var(--muted); font-size: 12.5px; font-weight: 800; }
.subject-v2-metrics strong { grid-row: 1 / 3; grid-column: 2; color: var(--navy); font-size: 20px; font-weight: 800; }
...
.subject-v2-metrics p { grid-column: 1 / -1; margin: 3px 0 0; color: var(--muted); font-size: 12.5px; }
...
.legacy-list-panel li > span { width: 26px; height: 26px; flex: 0 0 26px; display: grid; place-items: center; background: var(--teal-soft); border-radius: 50%; color: var(--teal); font-size: 12.5px; font-weight: 800; }
.growth-panel li > span { background: var(--coral-soft); color: var(--coral); }
.legacy-list-panel li p { margin: 0; color: var(--text); font-size: 13.5px; line-height: 1.65; }
...
.gap-rows article > div:first-child span { display: block; color: var(--brass-dark); font-size: 12.5px; font-weight: 800; }
.gap-rows article > div:first-child strong { display: block; margin-top: 4px; color: var(--ink-950); font-size: 13px; font-weight: 700; }
.gap-rows article > p { margin: 0; color: var(--text); font-size: 13px; line-height: 1.65; }
.gap-values { display: grid; grid-template-columns: 1fr 14px 1fr; gap: 5px; align-items: center; }
.gap-values p { margin: 0; padding: 8px; background: #fff; border-radius: 8px; color: var(--muted); font-size: 12.5px; text-align: center; }
.gap-values p b { margin-left: 3px; color: var(--navy); font-size: 14px; font-weight: 800; }
...
.roadmap-line span { color: var(--brass-dark); font-size: 12.5px; font-weight: 800; }
.roadmap-line strong { margin-top: 8px; display: block; color: var(--ink-950); font-size: 14px; font-weight: 700; }
.roadmap-line p { margin: 8px 0 0; color: var(--text); font-size: 13px; line-height: 1.65; }
.roadmap-line small { margin-top: 12px; display: block; padding-top: 9px; border-top: 1px solid var(--line); color: var(--teal); font-size: 12.5px; font-weight: 800; }
...
.verify-line > span { color: var(--brass-dark); font-size: 12.5px; font-weight: 800; }
.verify-line ul { margin: 12px 0 0; padding: 0; list-style: none; display: grid; gap: 8px; }
.verify-line li { display: flex; gap: 10px; color: var(--text); font-size: 13.5px; line-height: 1.55; }
...
.final-guidance > span { color: var(--brass-dark); font-size: 12.5px; font-weight: 800; }
.final-guidance h3 { margin: 10px 0 0; color: var(--navy); font-size: 18px; font-weight: 800; line-height: 1.55; word-break: keep-all; }
.final-guidance p { margin: 12px 0 0; padding-top: 12px; border-top: 1px solid #d7deea; color: var(--text); font-size: 13.5px; line-height: 1.8; word-break: keep-all; }
...
.report-v2-caution strong { color: var(--ink-950); font-size: 13px; font-weight: 800; }
.report-v2-caution p { margin: 0; color: var(--muted); font-size: 12.5px; line-height: 1.7; }

/* ── 하단 고정 dock(얇은 다크 필) ──────────────────────────── */
.report-dock {
  position: fixed; z-index: 120; bottom: max(14px, env(safe-area-inset-bottom)); left: 50%;
  width: min(680px, calc(100% - 24px)); padding: 6px;
...
.report-dock button { min-height: 44px; padding: 5px 6px; display: flex; flex-direction: column; align-items: center; justify-content: center; gap: 1px; background: transparent; border: 0; border-radius: 8px; color: #b3bccb; }
.report-dock button.is-active { background: #fff; color: var(--navy); }
.report-dock b { color: var(--brass-soft); font-size: 11px; font-weight: 800; }
.report-dock button.is-active b { color: var(--brass-dark); }
.report-dock span { font-size: 12px; font-weight: 800; white-space: nowrap; }

/* ── 모바일(카카오 인앱 우선, ≤760) ─────────────────────────── */
@media (max-width: 760px) {
  .rptv2-doc { font-size: 15px; }
  .report-v2-toolbar__inner { width: calc(100% - 24px); min-height: 56px; }
  .report-v2-toolbar .premium-brand small { display: none; }
  .report-v2-wrap { width: 100%; margin-top: 0; border-radius: 0; box-shadow: none; padding-bottom: 96px; }
  .report-v2-cover { padding: 24px 18px 20px; border-radius: 0; }
  .cover-layout { grid-template-columns: 1fr; gap: 20px; padding: 20px 0; }
  .cover-copy h1 { font-size: 26px; }
  .report-v2-section { padding: 28px 16px; }
  .luxury-section-heading h2 { font-size: 19px; }
  ...
  .analysis-verdict > h3 { font-size: 20px; margin: 12px 18px 0; }
  .analysis-verdict__title { padding: 18px 18px 0; }
  ...
  .report-dock { left: 0; right: 0; bottom: 0; width: 100%; border-radius: 0; transform: none; padding: 6px 8px calc(6px + env(safe-area-inset-bottom)); }
}
@media (max-width: 400px) {
  .cover-copy h1 { font-size: 23px; }
  .luxury-section-heading__num { width: 30px; height: 30px; flex-basis: 30px; }
}
...
@media print {
  ...
  .report-v2-wrap { width: 210mm; max-width: none; margin: 0; padding: 0; border-radius: 0; box-shadow: none; }
