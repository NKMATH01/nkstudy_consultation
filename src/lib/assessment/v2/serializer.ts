...
[출력 형식 — 아래 JSON 구조로만, 다른 텍스트 없이 반환]
{
  ...
  "detailedSummary": "학부모와 상담자가 함께 읽는 상세 총평. 수업 태도·숙제·휴대폰·목표 의지·회복력·친구 관계·선택 과목·NK 적합을 각각 최소 한 번씩 언급하는 4~6문단(쉬운 우리말·짧은 문장, 한 문단은 2~3문장). 문단은 빈 줄(줄바꿈 2번)로 구분하고, 부족한 점도 혼낼 점이 아니라 함께 도와줄 부분으로 표현",
  ...
  "parentSummary": "학부모 공유용 요약(쉽고 따뜻하게, 부모를 안심시키는 말투, 낙인·내부질문·연락처 없이 의미는 유지)",
